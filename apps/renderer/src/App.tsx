      ...
      >
        <header>
          <div>
            ...
            <span>所有数据仅保存在此电脑</span>
          </div>
          <button type="button" onClick={onClose} aria-label="关闭数据管理">
            <X size={18} />
          </button>
        </header>
  ...
  return (
    ...
    >
      <aside className="agent-sidebar" aria-label="股票助手会话导航">
        ...
        <section className="sidebar-quick-actions" aria-label="快捷操作">
          <p>快捷操作</p>
          <button type="button" onClick={() => setComposer("查看我的收藏标的") }>
            <Star size={15} /> 收藏标的
          </button>
          <button type="button" onClick={() => setComposer("生成一份研究模板") }>
            <FileText size={15} /> 研究模板
          </button>
          <button type="button" onClick={() => setComposer("回顾最近的研究结论") }>
            <History size={15} /> 历史结论
          </button>
        </section>
        ...
        <header className="agent-header">
          ...
          <div className="agent-header-actions">
            <button
              ...
              title={canvasOpen ? "隐藏股票画布" : "显示股票画布"}
            >
              {canvasOpen ? (
            ...
            <div className="agent-empty-chat app-shell-welcome">
              ...
              <div className="welcome-prompts">
                {[
                  ...
                  <button key={prompt} type="button" onClick={() => setComposer(prompt)}>
                    {prompt}
                  </button>
                ))}
              </div>
